...
export function Header({ scrollState, mobileMenuOpen, setMobileMenuOpen }) {
  ...
  // This value directly follows the scroll. When you scroll 100px, it goes up 100px.
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 h-full flex items-center justify-between">
        ...
        <motion.a
          href="#home"
          className="font-black uppercase tracking-[0.28em] text-[13px] pointer-events-auto"
          style={{
        ...
        <nav className="hidden md:flex items-center gap-10" aria-label="Main navigation">
          ...
          <motion.a
            ...
            className="text-[11px] uppercase tracking-[0.22em] font-semibold px-5 py-2.5 transition-colors duration-300 pointer-events-auto"
            initial={false}
            animate={{
              y: isPastHero ? 0 : 0, // Fallback if yNav isn't used below
            }}
            style={{
              ...
              y: isPastHero ? 0 : yNav, // Controlled by scroll progression unless past_hero
            }}
            onMouseEnter={(e) => {
              if (isPastHero) {
